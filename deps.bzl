...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Nrob4FwVgi5L4tV9lhjzZcjYqFVyJzsA56CwPaPfv6s=",
        version = "v2.14.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_kubernetes_csi_external_snapshotter_client_v6",
        importpath = "github.com/kubernetes-csi/external-snapshotter/client/v6",
        sum = "h1:cMM5AB37e9aRGjErygVT6EuBPB6s5a+l95OPERmSlVM=",
        version = "v6.2.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_openfga_go_sdk",
        importpath = "github.com/openfga/go-sdk",
        sum = "h1:zzQPdcX/CNLXwycqYNx5LvP78kzVs6R8p5GXw/0II3s=",
        version = "v0.2.2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_qmuntal_stateless",
        importpath = "github.com/qmuntal/stateless",
        sum = "h1:LNCxKG+7E20MONp78FXe1ROHEyFuL4UTUAfBRwyFV5w=",
        version = "v1.6.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fTNRhKstPKxcnoKsytm4sahr8FaYzUcT7i1/3nd/fBg=",
        version = "v1.16.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yGN2TZt9XIl5wrcYaFtVMqzP2GIzX5gIcOObCZCuDeA=",
        version = "v0.0.0-20220913193501-391367153a38",
    )
    go_repository(
        name = "io_k8s_klog_v2",
